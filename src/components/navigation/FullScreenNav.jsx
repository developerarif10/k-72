    ...
    >
      ...
      <div ref={fullNavLinksRef} className="relative">
        ...
        <div>
            ...
            <div className="link origin-top origin-top relative text-[100px] uppercase leading-[.9] pt-2 text-center font-[font2] text-white font-[900] border-y-1 border-[#252529]">
              ...
              <div className="moveLink absolute flex top-1 overflow-hidden bg-[#D3FD50] text-black">
                <div className="moveX flex items-center gap-x-4">
                  ...
                  <img
                    src="/agenceImages/WS---K72.ca---MenuThumbnail-640x290.jpg"
                    alt=""
                    className="rounded-full object-cover lg:w-52 shrink-0 h-20"
                  />
                  <h2 className="whitespace-nowrap">Pour Tout Voir</h2>
                  <img
                    src="/agenceImages/PJC_SiteK72_Thumbnail_640x290-640x290.jpg"
                    alt=""
                    className="rounded-full object-cover lg:w-52 shrink-0 h-20"
                  />
                </div>
                <div className="moveX flex items-center gap-x-4">
                  ...
                  <img
                    src="/agenceImages/WS---K72.ca---MenuThumbnail-640x290.jpg"
                    alt=""
                    className="rounded-full object-cover w-52 shrink-0 h-20"
                  />
                  <h2 className="whitespace-nowrap">Pour Tout Voir</h2>
                  <img
                    src="/agenceImages/PJC_SiteK72_Thumbnail_640x290-640x290.jpg"
          ...
          <div id="fullScreenNavContent">
            <div className="link origin-top relative text-[100px] uppercase leading-[.9] pt-2 text-center font-[font2] text-white font-[900] border-y-1 border-[#252525]">
              <h1>Agence</h1>
              <div className="moveLink absolute flex top-1 overflow-hidden bg-[#D3FD50] text-black">
                <div className="moveX flex items-center gap-x-4">
                  <h2 className="whitespace-nowrap">Pour Tout Voir</h2>
